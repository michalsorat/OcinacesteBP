...
{{--                    <th>Vyriešiť</th>--}}
                ...
                @if($problems == null)
                    <tr>
                        <td colspan="7" class="text-center">Žiadne problémy na schválenie</td>
                    </tr>
                @else
                    @foreach($problems as $counter=>$problem)
                        <tr onclick="window.location='{{ route('approvalProblemDetail', $problem->problem_id) }}'">
