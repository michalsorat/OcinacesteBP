...
{{--    <header>--}}
{{--        <div class="hdr-bckgrnd"></div>--}}
{{--        <nav class="main-nav">--}}
{{--            <div class="hdr-logos">--}}
{{--                <img class="logo-img_fiit" src="{{ asset('img/STU-FIIT-zfv.png') }}" height="60">--}}
{{--                <img class="logo-img" src="{{ asset('img/succttsklogo.jpg') }}" height="50">--}}
{{--            </div>--}}
{{--            <h1>Oči na ceste</h1>--}}
{{--            <a class="open-off-canvas d-block d-md-none">--}}
        ...
        <div class="bnr-holder">
            ...
            <div class="bnr-sidebar-right">
                <ul class="bnr-sidebar-options">
                    ...
                    @endguest
                    <li>
                        <a class="all-report-list" href="#">Všetky hlásenia</a>
                    </li>
                </ul>
            </div>
